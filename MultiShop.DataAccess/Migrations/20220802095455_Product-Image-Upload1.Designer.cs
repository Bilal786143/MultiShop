...
namespace MultiShop.DataAccess.Migrations
{
    ...
    [Migration("20220802095455_Product-Image-Upload1")]
    partial class ProductImageUpload1
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("MultiShop.Models.Models.Admins", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("MultiShop.Models.Models.CartDetails", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("MultiShop.Models.Models.CartHeader", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("MultiShop.Models.Models.OrderDetails", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("MultiShop.Models.Models.CartDetails", b =>
                {
                    b.HasOne("MultiShop.Models.Models.CartHeader", "CartHeader")
                        .WithMany()
                        .HasForeignKey("CartHeaderFId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("MultiShop.Models.Models.OrderDetails", b =>
                {
                    b.HasOne("MultiShop.Models.Models.Order", "Order")
                        .WithMany()
